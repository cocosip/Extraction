...
namespace ExtractionSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ExtractionSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ExtractionSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
